...
get_bg_color() {
    ...
    case "$_c" in
        ...
        "shower in vicinity"|"shower in vicinity, light rain"|\
        ...
        "rain in vicinity, rain"|"rain shower, mist, light rain")
            echo "#3a86ff" ;;
        ...
        "ice crystals"|"light snow shower, parftial fog"|"patchy light snow"|\
        "light snow grains")
            echo "#9eb5ba" ;;
        ...
        "thunderstorm, shower in vicinity"|\
        "thunderstorm, haze"|\
